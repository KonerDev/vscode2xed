...
export function convertThemePalette(theme, isDark, showWarnings = true) {
    ...
    return {
        ...
        editorColors: {
            ...
            // html_tag: '#000000',
            // identifier_name: '#03A9F4',
            // identifier_var: '#546E7A',
            // keyword: getTokenColor('keyword'),
            // line_block_label: '#000000',
