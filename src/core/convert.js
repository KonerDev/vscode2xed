...
export function convertThemePalette(theme, isDark, showWarnings = true) {
    ...
    return {
        ...
        editorColors: {
            ...
            current_row_border: getColor('editor.lineHighlightBorder'),
            ...
            text_highlight_strong_background: getColor('editor.wordHighlightStrongBackground'),
            text_highlight_strong_border: getColor('editor.wordHighlightStrongBorder'),
            text_highlight_background: getColor('editor.wordHighlightBackground'),
            text_highlight_border: getColor('editor.wordHighlightBorder'),
            highlighted_delimiters_background: getColor('editorBracketMatch.background'),
            ...
            highlighted_delimiters_border: getColor('editorBracketMatch.border'),
            ...
            matched_text_border: getColor('searchEditor.findMatchBorder'),
            non_printable_char: getColor('editorWhitespace.foreground'),
            problem_error: getColor('editorError.foreground'),
            problem_typo: getColor('editorInfo.foreground'),
            ...
            selected_text_border: ColorUtils.TRANSPARENT,
